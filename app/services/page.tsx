      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
          ...
          >
            ...
            <ul className="list-disc list-inside text-gray-400 text-sm sm:text-base">
              <li>Park and Sell opportunities</li>
              <li>Moving ads that go anywhere</li>
              <li>Strategic location targeting</li>
              <li>Customized activation experiences</li>
            </ul>
          </motion.div>
        </div>
      </div>
    ...
    <section className="py-16 sm:py-20 bg-gradient-to-b from-gray-900 to-black">
      <div className="container mx-auto px-4 text-center">
        ...
        <Button asChild size="lg" className="bg-white text-black hover:bg-gray-200 w-full sm:w-auto">
          <Link href="/contact">Get Started <ArrowRight className="ml-2" /></Link>
        </Button>
      </div>
    </section>
  )
